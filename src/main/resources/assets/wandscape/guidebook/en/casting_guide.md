...
Mages do not learn spells on their own: once a scroll has been copied at the 《Magic Workshop》 and has landed in the town warehouse, you still have to place it. Open the strategy page from the mage panel and drop the scroll into a category slot, and the mage will use that spell; take the scroll back out and it stops using it.
