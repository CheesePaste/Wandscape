...
- **Sub-modes** (the Build / Road construction states): the cursor is lifted so you can click the panel UI freely, and you rotate the camera by **holding right-click and dragging**. The **Tasks** tab opens a full-screen management hub that covers the sidebar and top bar.
...
4. **Quickly switch modes**: press **1 / 2 / 3** to jump straight to Build / Road / Tasks.
...
| **1 / 2 / 3** | Quickly switch to **Build / Road / Tasks** |
...
- **Tasks**: the full-screen task & mage management hub — a central view of global tasks and your wizards.
