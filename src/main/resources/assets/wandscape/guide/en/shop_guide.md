...
**Right-click the shop** to open the panel and set each good's **max stock** (0~64). The system auto-restocks from the warehouse; max stock decides how long a good lasts.
