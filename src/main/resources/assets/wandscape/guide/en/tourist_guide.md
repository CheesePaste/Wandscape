...
| **`Three Bars`** (Comfort/Magic/Wonder) | Display (`fill/need`) | — | The tourist's three need bars (Comfort/Magic/Wonder). Visiting matching buildings fills them; tourists with all three full leave experience at night, and mages leave resumes to be recruited. |
