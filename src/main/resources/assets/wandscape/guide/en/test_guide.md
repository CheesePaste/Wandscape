...
- **Bold text**: this is a **Bold Text** demo.
- *Italic text*: this is an *Italic Text* demo.
...
- Supports `.gif` multi-frame animated sequence playback

1. First step: place the Town Hall and initial buildings
2. Second step: lay connecting roads to guide tourists into town
3. Third step: build shops and taverns to earn elemental income
