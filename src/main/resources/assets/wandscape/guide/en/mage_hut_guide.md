...
When opened while empty:
- The left panel shows all unassigned colony mages.
- Select a candidate and click "**Assign to Hut**" to move them in.
- If no mages are available, recruit new mages at the [Tavern](tavern_guide.md).
