...
public class NpcDataImpl implements NpcData {
    ...
    public static NpcDataImpl from(WandscapeNpc npc) {
        return new NpcDataImpl(
                ...
                (int) npc.getHealth(),
                npc.getEffectiveAttribute(com.wsteam.wandscape.core.types.AttributeType.SPELL_POWER),
                npc.getEffectiveAttribute(com.wsteam.wandscape.core.types.AttributeType.WORK_SPEED),
                npc.getEffectiveAttribute(com.wsteam.wandscape.core.types.AttributeType.SPELL_SPEED),
