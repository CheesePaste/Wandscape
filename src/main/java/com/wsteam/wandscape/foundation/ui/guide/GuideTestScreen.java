...
public class GuideTestScreen extends MedievalScreen {
    ...
    private void handleGameAction(String action) {
        if ("action:wandscape:overview_mode".equals(action)) {
            this.onClose();
            com.wsteam.wandscape.foundation.ui.panel.WandscapePanelState.openPanel();
            com.wsteam.wandscape.foundation.ui.panel.WandscapePanelState.enterSubMode(
                    com.wsteam.wandscape.foundation.ui.panel.WandscapePanelState.SubMode.OVERVIEW);
        } else {
