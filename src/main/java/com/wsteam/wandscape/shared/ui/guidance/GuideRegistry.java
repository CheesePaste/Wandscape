...
public final class GuideRegistry {
    ...
    private static final GuideStep TOWN_HALL = new GuideStep(
            ...
            List.of(
                    "§a▶ 1. 点击左侧边栏 🏛️【建造】图标",
                    "§7  2. 在【市政厅】分类中找到【市政厅】",
                    "§7  3. §e单击§7卡片选中建筑，§e双击§7收回鼠标进入放置"),
            List.of(
                    "§7✓ 1. 已打开建造面板",
                    "§a▶ 2. 在下方列表§e单击【市政厅】§7选中，§e双击§7进入放置",
                    "§7  3. 世界中§e右键§7固定虚影并打开施工 UI"),
            List.of(
                    "§7✓ 1. 已选中市政厅蓝图",
                    "§7✓ 2. 建筑虚影已在世界中显现",
                    "§a▶ 3. 移动视角选好位置，§e右键§7打开施工 UI，调整坐标后 §eSubmit§7 建造"),
            "💡 提示：左键旋转建筑朝向");
    ...
    private static final GuideStep WAREHOUSE = new GuideStep(
            ...
            List.of(
                    "§7✓ 1. 已打开建造面板",
                    "§a▶ 2. 切换至【仓库/存储】分类，§e单击【仓库】§7选中，§e双击§7进入放置",
                    "§7  3. 世界中§e右键§7固定虚影并打开施工 UI"),
            List.of(
                    "§7✓ 1. 已选中仓库蓝图",
                    "§7✓ 2. 建筑虚影已在世界中显现",
    ...
    private static final GuideStep NODE = new GuideStep(
            ...
            List.of(
                    "§7✓ 1. 已打开建造面板",
                    "§a▶ 2. 切换至【元素节点】分类，§e单击节点§7选中，§e双击§7进入放置",
                    "§7  3. 世界中§e右键§7固定虚影并打开施工 UI"),
            List.of(
                    "§7✓ 1. 已选中节点蓝图",
                    "§7✓ 2. 建筑虚影已在世界中显现",
    ...
    private static final GuideStep WORKSTATION = new GuideStep(
            ...
            List.of(
                    "§7✓ 1. 已打开建造面板",
                    "§a▶ 2. 切换至【生产工坊】分类，§e单击工作台§7选中，§e双击§7进入放置",
                    "§7  3. 世界中§e右键§7固定虚影并打开施工 UI"),
            List.of(
                    "§7✓ 1. 已选中工作台蓝图",
                    "§7✓ 2. 建筑虚影已在世界中显现",
    ...
    private static final GuideStep CRAFT_STATION = new GuideStep(
            ...
            List.of(
                    "§7✓ 1. 已打开建造面板",
                    "§a▶ 2. 切换至【法宝合成】分类，§e单击合成站§7选中，§e双击§7进入放置",
                    "§7  3. 世界中§e右键§7固定虚影并打开施工 UI"),
            List.of(
                    "§7✓ 1. 已选中合成站蓝图",
                    "§7✓ 2. 建筑虚影已在世界中显现",
    ...
    private static final GuideStep SHOP = new GuideStep(
            ...
            List.of(
                    "§7✓ 1. 已打开建造面板",
                    "§a▶ 2. 切换至【商业/商店】分类，§e单击商店§7选中，§e双击§7进入放置",
                    "§7  3. 世界中§e右键§7固定虚影并打开施工 UI"),
            List.of(
                    "§7✓ 1. 已选中商店蓝图",
                    "§7✓ 2. 建筑虚影已在世界中显现",
    ...
    private static final GuideStep INN = new GuideStep(
            ...
            List.of(
                    "§7✓ 1. 已打开建造面板",
                    "§a▶ 2. 切换至【服务/旅店】分类，§e单击旅店§7选中，§e双击§7进入放置",
                    "§7  3. 世界中§e右键§7固定虚影并打开施工 UI"),
            List.of(
                    "§7✓ 1. 已选中旅店蓝图",
                    "§7✓ 2. 建筑虚影已在世界中显现",
    ...
    private static final GuideStep TAVERN = new GuideStep(
            ...
            List.of(
                    "§7✓ 1. 已打开建造面板",
                    "§a▶ 2. 找到并§e单击【冒险者酒馆】§7选中，§e双击§7进入放置",
                    "§7  3. 世界中§e右键§7固定虚影并打开施工 UI"),
            List.of(
                    "§7✓ 1. 已选中酒馆蓝图",
                    "§7✓ 2. 建筑虚影已在世界中显现",
