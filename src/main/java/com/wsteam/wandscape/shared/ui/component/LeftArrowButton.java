...
public class LeftArrowButton extends AbstractButton {
    ...
    public LeftArrowButton(int x, int y, MedievalButton.OnPress onPress) {
        super(x, y, 20, 14, Component.empty());
        this.onPress = onPress;
    }

    public LeftArrowButton(int x, int y, int width, int height, MedievalButton.OnPress onPress) {
    ...
    protected void updateWidgetNarration(NarrationElementOutput output) {
        output.add(NarratedElementType.USAGE, Component.literal("Left arrow button"));
    }
}
