...
import org.magiccolony.core.boundary.BlockOps;
import org.magiccolony.core.boundary.ColonyResourceAccess;
import org.magiccolony.core.boundary.EntityOps;
import org.magiccolony.core.boundary.RitualOps;
import org.magiccolony.core.component.Inventory;
import org.magiccolony.core.component.Position;
import org.magiccolony.core.component.TaskExecutor;
import org.magiccolony.core.ecs.World;
import org.magiccolony.core.event.CustomEvent;
import org.magiccolony.core.types.BlockType;
...
public final class DefaultOpExecutors {
    ...
    static class ResourceBelowCondition implements ConditionEvaluator {
        ...
        public boolean evaluate(Map<String, String> params, World world, long npcId) {
            ...
            int available = resources.available(new org.magiccolony.core.types.ResourceId(resourceName));
    ...
    static class InventoryHasCondition implements ConditionEvaluator {
        ...
        public boolean evaluate(Map<String, String> params, World world, long npcId) {
            ...
            return inv.count(new org.magiccolony.core.types.ResourceId(resourceName)) >= amount;
        }
    }
