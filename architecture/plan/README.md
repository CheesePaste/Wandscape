...
| **4** | `shared/data/BarRatio.java`(新)、`shared/api/TouristApi.java`、`tourist/internal/TouristApiImpl.java`、`shared/event/TouristDepartedEvent.java`、`shared/data/ColonyMetricsSnapshot.java`、`engine/service/ColonyMetricsService.java`、`stats/internal/StatisticsCollector.java`、`stats/data/ColonyDailySnapshot.java`、`stats/internal/StatisticsData.java`、`stats/data/ColonyStatsSummary.java`、`stats/network/StatsSyncPacket.java`、`shared/ui/panel/WandscapePanelState.java`、`shared/ui/panel/WandscapePanelOverlay.java`、`shared/data/VisitMemory.java`、`shared/data/Emotion.java`、`shared/data/NarrativeEventType.java`、`shared/client/bubble/AmbientTextPools.java`、`shared/client/bubble/TransientBubbleStore.java`、`shared/client/bubble/SatisfactionBarRenderer.java`(删)、`shared/client/bubble/SpeechBubbleRenderer.java`、`building/internal/BuildingApiImpl.java`、`BuildingContributionRegistry.java`、`DailySettlementSystem.java`、`BuildingInteractHandler.java`、`engine/service/AchievementService.java`、`GuideProgressService.java`、`shared/ui/panel/BuildingSelectionOverlay.java`、`projection/network/ProjectionNetwork.java`、`building/client/BuildingAreaRenderer.java`、`tourist/internal/NarrativeGenerator.java`、`NarrativeTemplates.java`、`command/TouristCommand.java`、`shared/api/TavernApi.java`、`tourist/internal/TavernRecruitStorage.java`、`building/client/TavernScreen.java`、`shared/data/MageResume.java`、`engine/colony/ColonyLevelManager.java`、`ColonyLevelData.java`、`engine/service/StatsService.java`、lang/narratives JSON/guide 文案 |
...
| [block-4-category-sweep.md](block-4-category-sweep.md) | category + 满意度清扫（shop/service 保留，加 relax/atm）：三条表示贯穿 API/事件/stats/HUD、情绪叙事对接、删瞬时头顶条、文案 |
