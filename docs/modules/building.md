...
- `BuildingBreakHandler`：BreakEvent/ExplosionEvent 复检，broken 则 structureIntact=false、删贡献、town_hall 则删殖民地、入队 `build:place_structure` 修复任务（优先 49, addFirst）；`triggerRepair` 供"修复"按钮。
